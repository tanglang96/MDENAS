...
class PoolBN(nn.Module):
    ...
    def __init__(self, pool_type, C, kernel_size, stride, padding, affine=True):
        ...
        bn = nn.BatchNorm2d(C, affine=affine)
        self.f = nn.Sequential(OrderedDict([('pool', pool), ('bn', bn)]))
...
class StdConv(nn.Module):
    ...
    def __init__(self, C_in, C_out, kernel_size, stride, padding, affine=True):
        ...
        self.net = nn.Sequential(OrderedDict([
            ('relu', nn.ReLU()),
            ('conv', nn.Conv2d(C_in, C_out, kernel_size, stride, padding, bias=False)),
...
class FactorizedReduce(nn.Module):
    ...
    def __init__(self, C_in, C_out, affine=True):
        ...
        self.bn = nn.Sequential(OrderedDict([('bn', nn.BatchNorm2d(C_out, affine=affine))]))
