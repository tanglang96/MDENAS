...
from models.darts_nets_cifar.augment_cells import AugmentCell
...
class AugmentCNN(MyNetwork):
    """ Augmented CNN model """

    def __init__(self, input_size=32, C_in=3, C=36, n_classes=10, n_layers=20, auxiliary=True, genotype=None,
                 stem_multiplier=3, drop_out=0.0,
                 bn_param=(0.1, 1e-3)):
        """
        Args:
